...
class Shelf(models.Model):
    ...
    max_borrow_per_student = models.PositiveIntegerField(default=1, help_text="Maximum books a student can borrow from this shelf.")  # NEW FIELD
...
class Book(models.Model):
    ...
    book_number = models.CharField(max_length=255, unique=True, null=True, blank=True)  # for legacy books
...
class Student(models.Model):
    ...
    student_picture = models.ImageField(upload_to='student_pictures/', null=True, blank=True)
